...
export const PersonalDetails = () => {
  ...
  return (
    <section className="personal-details mt-4" id="personal">
      <div className="personal_info">
        <div className="connect_section">
          <h3 className="connect_title">Let's Connect</h3>
          <p className="connect_description"> I'm always open to discussing new opportunities, collaborations, or just having a chat about tech! </p>
        </div>
        ...
        <div className="opportunities_section">
          <span className="opportunities_label">Available for opportunities as</span>
        ...
        <div className="hire_me_section">
          <a href="mailto:yourmail@gmail.com" className="hire_me_btn">
      ...
      <div className="personal_footer">
        <span className="copyright_text">© {new Date().getFullYear()} Kalyan Kumar. All rights reserved.</span>
      ...
      <button className="scroll_top_btn" type="button" onClick={scrollToTop} aria-label="Scroll to top">
        <ArrowUpwardIcon />
      </button>
    </section>
  );
